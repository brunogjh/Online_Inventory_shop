...
/*this is delet quer*/
mysqli_query($con,"delete from sup_info where id='$user_id'")or die("query is incorrect...");
}
...
?>
	...
	<th><a href="addsuppliers.php" class="btn btn-success">Add New</a></th>
                    ...
                    <tbody>
                      <?php 
                        $result=mysqli_query($con,"select id,first_name,last_name, email, password,mobile,address1,address2 from sup_info")or die ("query 2 incorrect.......");
